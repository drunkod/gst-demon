...
#    The -A packages.gstreamerAndroid.source attribute points to the fetchurl
#    derivation in our Nix configuration.
log_info "Running nix-build to fetch GStreamer binaries..."
GSTREAMER_TARBALL=$(nix-build --no-out-link -A packages.gstreamerAndroid.source)
