...
let
  ...
  # Import modules
  packages = import ./modules/packages.nix { inherit extendedPkgs gstreamerDaemon scripts; };
  ...
  imports = [
    {
      ...
      # Expose gstreamer-android for the setup script
      gstreamerAndroid = gstreamerAndroid;
    }
    previews
    workspace
  ];
